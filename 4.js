...
class SvgPlus{
  ...
  */
  ...
  static addCSSSStyleSheet(sheet) {
    let oldStyles = document.adoptedStyleSheets;
    let styles = [sheet];
    for (let style of oldStyles) {
      styles.push(style);
    }
...
export {SvgPlus, PlusError, SvgPath, LinkItem, LinkList, CPoint, DPath, Vector, Td, Tr, THead, TBody}
